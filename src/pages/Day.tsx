...
import { Divider, Spinner, Table, TableBody, TableCell, TableColumn, TableHeader, TableRow, getKeyValue } from "@nextui-org/react";
            ...
            .then(res => {
                ...
                fetch('https://rain-memo-backend.onrender.com/netatmo/getRain',
                    ...
                    .then(data => {
                        ...
                        setData(dataWithKey)
                        setDataFormatted(dataWithKey.map((d: any) => ({ key: d.key, date: new Date((d.date - 60 * 30) * 1000).toLocaleString("no-NO").split(',')[1], amount: parseFloat(d.amount.toFixed(2)) })))
                    }
                    )
            })
    }, [])
